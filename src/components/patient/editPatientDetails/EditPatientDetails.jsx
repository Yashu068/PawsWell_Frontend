        ...
        <div className='editpatientdetails'>
            ...
            <div className='editpatientdata'>
                <div className='editpatientdataleft'>
                    <div className='editpatientlabel'>Pet Name <input type='text' className='patientlabelinput' name="name" id='l1' value={patientDetails.name} onChange={onChange} disabled></input> </div>
                    <div className='editpatientlabel'>Owner's Email <input type='email' className='patientlabelinput' name="email" id='l1' value={patientDetails.email} onChange={onChange} disabled></input></div>
                ...
                <div className='editpatientdataright'>
                    <div className='editpatientlabel'>Owner's Phone <input type='number' className='patientlabelinput' name="phone" id='l1' value={patientDetails.phone} onChange={onChange}></input></div>
                    <div className='editpatientlabel'>Pet ID<input type='number' className='patientlabelinput' name="adhar_no" id='l1' value={patientDetails.adhar_no} onChange={onChange}></input></div>
                    <div className='editpatientlabel'>Owner's Name <input type='text' className='patientlabelinput' name="father_name" id='l1' value={patientDetails.father_name} onChange={onChange}></input></div>
                    <div className='editpatientlabel'>Species <input type='text' className='patientlabelinput' name="mother_name" id='l1' value={patientDetails.mother_name} onChange={onChange}></input></div>
                    <div className='editpatientlabel'>Breed <input type='text' className='patientlabelinput' name="marital_status" id='l1' value={patientDetails.marital_status} onChange={onChange}></input></div>
                </div>
            </div>
        </div>
    )
