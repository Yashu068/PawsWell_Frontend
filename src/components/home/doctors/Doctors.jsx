        ...
        <div className='doctors'>
            ...
            <div className='doctorslower'>
                ...
                <img className='doctorsc1image' src={d1} alt='d1'></img>
                    <h5 className='doctorsc1h5'>Dr. Andy Roark </h5>
                    <p className='doctorsc1p'>Dog Specialist </p>
                </div>
                <div className='doctorsc2'>
                <img className='doctorsc1image' src={d2} alt='d2'></img>
                    <h5 className='doctorsc1h5'>Dr. Evan Antin</h5>
                    <p className='doctorsc1p'>Dog Specialist </p>
                </div>
                <div className='doctorsc2'>
                <img className='doctorsc1image' src={d3} alt='d3'></img>
                    <h5 className='doctorsc1h5'>Dr. Lisa Lippman</h5>
                    <p className='doctorsc1p'>Cat Specialist</p>
                </div>
                <div className='doctorsc2'>
                <img className='doctorsc1image' src={d4} alt='d4'></img>
                    <h5 className='doctorsc1h5'>Dr. Marty Becker</h5>
                    <p className='doctorsc1p'>Dog Specialist</p>
                </div>
            </div>
        </div>
