...
import './Navbar2.css'
import hospital from '../images/logo.jpg';
  ...
  return (
    <div className='navbar2'>
      ...
      <div className='navbar22'>
        <div className='navbar221'><img className='navbar221img' src={email} alt=''></img>support@yourpetcarewebsite.com</div>
        <div className='navbar221'><img className='navbar222img' src={phone} alt=''></img>9893951810</div>
